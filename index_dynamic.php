<?php
// index_dynamic.php
// Updated index page with dynamic functionality
...
<body>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div id="myTeamsList">
                                    ...
                                    <div class="alert alert-info">Você ainda não faz parte de nenhuma equipe.</div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        async function loadRecipes() {
            const response = await apiCall('recipes.php', 'GET');
